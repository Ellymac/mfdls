...
\newpage
\section{Conclusion}
Dire qu'on s'est rendus compte en implémentant nos raffinements que c'était plus compliqué que le truc de base ? (et qu'elle nous l'a fait remarquer à la soutenance)
